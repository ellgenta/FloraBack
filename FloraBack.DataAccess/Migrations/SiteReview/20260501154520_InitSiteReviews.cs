...
{
    /// <inheritdoc />
    public partial class InitSiteReviews : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultAddress_State = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultAddress_Street = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultAddress_House = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultAddress_Apartment = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItem_OrderData_OrderId",
                        column: x => x.OrderId,
